...
<jsp:useBean id="venditeb" scope="session" class="it.uniroma2.ispw.bean.VenditeBean"/>
<jsp:setProperty name="venditeb" property="*"/>
...
<body id="page-top" class="index">
    ...
    <% venditeb.riempiLista(us.getEmail()); %>
	...
	<div id="page-wrapper">
			...
			<div class="row text-center">
				<div class="panel panel-default">
					<div class="panel-heading"><h4>Lista vendite</h4></div>
				</div>
			</div>
			
			<%
				Ordine o = null;
				List<LineaOrdine> lo = venditeb.getListaLineeOrdine();
				LineaOrdine l = null;
				if(lo.size() != 0){
			...
			<div class="panel panel-default">
				<div class="panel-heading">Linea ordine id: <%= l.getIdLineaOrdine() %></div>
					...
					<table class="table">
						...
						<tbody>
							...
							<td><%= l.getOrdine().getUtenteReg().getEmail() %></td>
							</tr>
